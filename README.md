...
6. 	Run the project (quick run by pressing "CTRL + F5")
7. 	Open Postman
8. 	Import the "Reddit_Api.postman_collection.json"
9. 	Register a new user
	- The user details have already been added to the body
10. Authenticate the user
	- The user details have already been added to the body
11.	You will need to use the accessToken for all the requests
	- Copy the accessToken (without "")
12. Set the postman requests authorization as "Bearer" and paste the access token
13. Test the requests provided (The DB will be empty, you need to start by creating a post)
